...
import quote_start from "@/public/images/quote_start.png";
import quote_end from "@/public/images/quote_end.png";
...
export default function Testimonials() {
  ...
  return (
    <div id="testimonials" className="relative w-screen py-24 bg-white">
      <div className="">
        ...
        <div className="mt-20 ">
          ...
          <div className="flex relative w-screen gap-5 px-6 lg:px-32">
            <Image
            ...
            {/* Navigation buttons */}
            <div className="hidden lg:flex absolute z-10 right-4 lg:right-32 bottom-10 items-center gap-5">
              <button
          ...
          {/* Navigation buttons */}
          <div className="flex lg:hidden z-10 items-center justify-center gap-5">
            <button
              onClick={() => goToPrevious()}
              className="shadow-2xl shadow-black/50 bg-white rounded-full p-4 hover:bg-gradient-to-br hover:from-[#4fadff0f] hover:to-[#ff284c0e] focus:outline-none transition-colors duration-200"
              aria-label="Previous testimonial"
