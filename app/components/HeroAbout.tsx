...
const HeroAbout = () => {
  return (
    <section className="isolate max-w-7xl text-white h-[90vh] mx-auto px-4 flex flex-col items-center justify-center gap-5 sm:px-6 lg:px-8 text-center">
      <div className="absolute w-screen h-[130vh] inset-0 -z-10">
        <Image
          src={HeroImage}
      ...
      <div className="border bg-white/15 backdrop-blur-md border-white p-5 rounded-3xl m-2">
        <p
          className={`my-4 text-sm sm:text-lg font-bold  ${montserrat.className}`}
        >
        ...
        <p className="mt-1 text-md text-left">
