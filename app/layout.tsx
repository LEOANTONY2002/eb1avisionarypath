...
export const metadata: Metadata = {
  ...
  title: "EB1A Visionary Path - Expert Immigration Guidance",
  description:
    "Professional immigration guidance for EB1A, O1A, and EB2 NIW visas. Expert guidance for your immigration journey.",
  keywords:
    "EB1A visa, O1A visa, EB2 NIW, EB1A immigration, immigration guidance, visa consulting, US immigration, green card, immigration lawyer",
  openGraph: {
    type: "website",
    title: "EB1A Visionary Path - Expert Immigration Guidance",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "EB1A Visionary Path - Expert Immigration Guidance",
      },
    ],
    locale: "en-US",
  },
